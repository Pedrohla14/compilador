...
#line 1234 "linguagem.tab.c"
    break;

  case 6: /* tipo: INTEIRO  */
#line 105 "linguagem.y"
              { (yyval.str) = strdup("int"); }
#line 1240 "linguagem.tab.c"
    break;
